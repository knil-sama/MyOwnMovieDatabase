...
public class ComptageLettre {
  static class ComptageLettreMapper extends Mapper <LongWritable, Text, Text, IntWritable> {
  ...
  public static class ComptageLettreReducer extends Reducer <Text, IntWritable, Text, IntWritable> {
  ...
  public static void main (String args []) throws Exception {
    if (args.length != 2) {
      ...
      System.err.println ("Usage : ComptageLettre <source> <destination>") ;
      System.exit (-1) ;
    }

    Job job = new Job () ;
    job.setJarByClass (ComptageLettre.class) ;
    ...
    job.setMapperClass (ComptageLettreMapper.class) ;
    //job.setCombinerClass (ComptageMotCombiner.class) ;
    job.setReducerClass (ComptageLettreReducer.class) ;
