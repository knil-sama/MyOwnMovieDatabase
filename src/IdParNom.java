...
* dntt@u-cergy.fr 2014/03/05 : ComptageMot simple pour utilisation de MapReduce pour Hadoop 2.x
 */ import java.io.IOException ; import java.lang.InterruptedException ; import java.util.StringTokenizer ;

import org.apache.hadoop.fs.Path ; import org.apache.hadoop.conf.Configuration ; import org.apache.hadoop.io.Text; import 
org.apache.hadoop.io.LongWritable; import org.apache.hadoop.io.IntWritable;

import org.apache.hadoop.mapreduce.Mapper ; import org.apache.hadoop.mapreduce.Reducer ; import org.apache.hadoop.mapreduce.Job ;
...
public class IdParNom {
  static class IdParNomMapper extends Mapper <LongWritable, Text, Text, Text> {
	...
	String identifiant = tokenizer.nextToken();
	tokenizer.nextToken();
	String nom = tokenizer.nextToken();
       	contexte.write (new Text(nom), new Text (identifiant)) ;
  }
  }

  public static class IdParNomReducer extends Reducer <Text, Text, Text, Text> {
    public void reduce (Text clef, Iterable <Text> valeurs,
...
//		liste += val + ", ";
       	...
       	contexte.write (clef, new Text(liste)) ;
  ...
  public static void main (String args []) throws Exception {
    if (args.length != 2) {
      ...
      System.err.println ("Usage : IdParNom <source> <destination>") ;
      System.exit (-1) ;
    }

    Job job = new Job () ;
    job.setJarByClass (IdParNom.class) ;
    ...
    job.setMapperClass (IdParNomMapper.class) ;
    //job.setCombinerClass (ComptageMotCombiner.class) ;
    job.setReducerClass (IdParNomReducer.class) ;
